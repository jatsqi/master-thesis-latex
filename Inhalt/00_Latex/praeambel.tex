...
\sisetup{locale=US, range-phrase={~bis~}, output-decimal-marker={.}} % Damit ein Komma und kein Punkt verwendet wird.
...
% Custom Commands
\newcommand{\acfreverse}[1]{\acs{#1} (\acl{#1})}
